...
const tools = [
  ...
  },
  {
    icon: FileText,
    title: 'PDF Tools',
    description: 'Compress, merge, split, convert PDFs. Generate cover pages, format assignments. Everything a Nigerian student needs for document handling.',
    color: 'cyan',
  ...
  },
  {
    ...
    description: 'Build a professional CV tailored for Nigerian students. Perfect for SIWES, NYSC, internships and graduate job applications.',
    color: 'green',
  ...
  },
  {
    ...
    description: 'Get AI-powered help understanding any course topic. Summarize notes, explain concepts, and prepare smarter for exams.',
    color: 'amber',
